...
<p align="center">
  ...
  <a href="mailto:aipramod999@gmail.com">Email</a> • 
...
💼 Currently **AI Engineer at Andromeda 360**, building production backend services (Python/FastAPI, MongoDB, Docker) for an AI-powered agentic commerce platform  
📊 Previously **Data Scientist (AI/ML) at National Transfer Network**, building ML pipelines and predictive models on 50K+ student records, and exploring RAG + LLM career-advising agents  
💼 Started my career as a **Cloud Data Analyst at Oracle**, optimizing SQL/ERP data pipelines and delivering insights for enterprise clients  
...
**Tools & Frameworks:** PyTorch, TensorFlow, Flask, FastAPI, Docker, Git, REST APIs, AWS, RabbitMQ, Postman  
**Data Science:** Pandas, NumPy, Scikit-learn, Tableau, Power BI, EDA, Stats, Spark, Hadoop  
**ML/AI:** Time Series Forecasting, NLP, LSTM, SVM, Random Forest, Unsupervised & Supervised Learning, LLMs, RAG, LangChain, LangGraph, AI Agents  
...
### 🩺 [AI Healthcare Chatbot (Medi-Bot)](https://github.com/aishwarya4699/AI-Healthcare-Chatbot) — *Latest*
- Built a full-stack RAG chatbot to give patients quick, reliable medical answers and reduce misinformation
- Architected the pipeline with **LangChain** as orchestrator: query embedding → **Pinecone** similarity search over medical knowledge → **OpenAI GPT** for response generation
- Deployed on **AWS EC2** via Docker containers pushed to **Amazon ECR**, with a full **CI/CD pipeline (GitHub Actions)** for automated build and deployment
- Delivered a live Flask-based web app answering real medical queries (e.g., symptoms, prevention, treatment) with context-grounded, natural-language responses
...
🌟 Open to **Data Science**, **AI Engineering**, **Software Engineering** roles  
